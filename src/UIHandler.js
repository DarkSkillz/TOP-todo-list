import { Task, Librarian } from './classes.js';
...
const UIhandler = (() => {
    ...
    const addProjectForm = () => {
        ...
        cancelSVG.innerHTML =
            '<svg class="cancelSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Cancel</title><path d="M20 6.91L17.09 4L12 9.09L6.91 4L4 6.91L9.09 12L4 17.09L6.91 20L12 14.91L17.09 20L20 17.09L14.91 12L20 6.91Z" /></svg>';
    ...
    const resetCurrentProject = () => {
        ...
        updateCurrentProject();
        document.querySelector('.currentProject').innerText =
            currentProjectName;
    };
    ...
    const taskCreationForm = () => {
        ...
        nameErrMsg.innerText =
            'A task of this name already exists within this project!';
        ...
        if (currentProjectName == 'All Projects') {
            ...
            inputSubmitTask.addEventListener('click', (e) => {
                ...
                if (data.name.trim() == '') {
                    ...
                    currentProject.taskNames.includes(
    ...
    const taskEditForm = (task) => {
        ...
        inputEditTask.addEventListener('click', (e) => {
            ...
            if (data.name == '') {
                ...
                currentProject.taskNames.includes(taskName) &&
        ...
        if (currentProjectName !== 'All Projects') {
            inputSubmitProject.addEventListener('click', (e) => {
                ...
                if (
                    ...
                    projectNames.splice(
                        projectNames.indexOf(currentProject.name),
                        1,
                    );
    ...
    const addTaskCard = (name, parent, date, priority, status) => {
        ...
        taskDeleteBtn.addEventListener('click', (e) => {
            if (
                !document.contains(document.querySelector('.deleteConfirmBox'))
            ) {
                deleteConfirmBox(
                    'task',
                    e.currentTarget.parentElement.parentElement.querySelector(
            ...
            project.tasks.forEach((task) => {
                localStorage.setItem(
                    ...
                    localStorage.getItem(project.name) +
                        `${task.name},dataSeparator,${task.parent},dataSeparator,${task.date},dataSeparator,${task.priority},dataSeparator,${task.status}/taskSeparator/`,
                );
            });
        });
    };
