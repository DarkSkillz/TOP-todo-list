const handleUI = (() => {
    ...
    const addProjectForm = () => {
        ...
        form.className = "addProjectForm hidden"
        ...
        inputSubmit.setAttribute("value","Confirm")
    ...
    const taskCreationForm = () => {
        const form = document.createElement("form")
        form.className = "taskCreationForm hidden"
        ...
        form.append(cancelSVG, taskNameInputDiv, taskDateInputDiv, taskPriorityInputDiv, taskStatusInputDiv, inputSubmit)
    ...
    const deleteConfirmBox = () => {
        ...
        deleteConfirmBoxDiv.className = "deleteConfirmBox hidden"
    ...
    return {addProjectForm, taskCreationForm, deleteConfirmBox}
})()
